...
## Verificatie (gepland)
- `node --check` hash.js + poa-report.js + app.js
- JSON-valid i18n + version
- Playwright E2E: round-trip hash → embed → verify (match groen) + corrupt-PDF (mismatch rood)
- Smoke /api/anchor met stub-mode
